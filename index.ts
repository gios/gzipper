  ...
  public getOptions(): this {
    ...
    const options: GlobalOptions = {
      ...
      threshold:
        ...
        program.threshold ||
        0,
      // @deprecated GZIPPER_GZIP_LEVEL, gzipLevel
      level:
        parseInt(this.env.GZIPPER_LEVEL as string) ||
        program.level ||
        parseInt(this.env.GZIPPER_GZIP_LEVEL as string) ||
        program.gzipLevel,
      // @deprecated GZIPPER_GZIP_MEMORY_LEVEL, gzipMemoryLevel
      memoryLevel:
